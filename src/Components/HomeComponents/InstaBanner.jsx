    ...
    <div className="container mx-auto py-25">
      <div className="imgSec relative flex justify-center items-center w-full group">
        ...
        <div className="instaLogo absolute overflow-hidden h-[50%] w-35 bg-[#b8b8b8] flex flex-col z-10 cursor-pointer opacity-0 scale-75 group-hover:opacity-100 group-hover:scale-100 transition-all duration-500 ease-in-out">
          <span className="h-3/4 flex justify-center items-center text-4xl translate-y-4 group-hover:translate-y-0 transition-all duration-1000 ease-in-out">
            <FaInstagram />
          </span>
          <div className="call w-full h-1/4 translate-y-10 overflow-hidden bg-black text-white hover:bg-pink-700 font-semibold text-sm tracking-[2em] group-hover:tracking-wider font-poppins flex justify-center items-center group-hover:translate-y-0 transition-all duration-1000 ease-in-out">
            <span>FOLLOW</span>
          </div>
        </div>
        <div className="instaOverlay absolute w-240 h-full top-0 left-[12.5%] bg-[#000000a6] z-0 opacity-0 group-hover:opacity-100 transition-opacity duration-1000 ease-in-out"></div>
      </div>
    </div>
  );
};
