...
const Contact = () => {
  return (
    <section className="bg-white dark:bg-gray-900 my-10 font-poppins">
  <div className="py-8 lg:py-16 px-4 mx-auto max-w-screen-md">
      <h2 className="mb-4 text-[60px] text-pink-700 tracking-tight font-extrabold text-center dark:text-white font-rochester">Contact Us</h2>
